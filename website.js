...
function fetchResponse(userInput) {
    const intents = [
        ...
        }
        {
            ...
            "responses": ["It is okay to be sad. Try to make yourself feel better by understanding that your not alone. Also, remember that you are amazing."]
        },
               {
            "tag": "secret",
            "patterns": ["what are you plotting?"],
            "responses": ["Don't tell anyone....","I will find you!","YOU BETTER HIDE!"]
        },
